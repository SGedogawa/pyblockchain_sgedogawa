...
class Wallet(object):
    ...
    def generate_blockchain_address(self):
        ...
        ripemed160_bpk_hex = codecs.encode(
            ripemed160_bpk_digest, 'hex'
        )

        network_bytes = b'00'
        network_bitcoin_public_key = network_bytes + ripemed160_bpk_hex
...
class Transaction(object):
    ...
    def generate_signature(self):
        ...
        transaction = utils.sorted_dict_by_key({
            'sender_block_chain_address': self.sender_address,
